...
- When creating a new issue there are several types to choose from. Most issues will be of type 'Regular issue', but to propose a new Theme, Campaign, use a proposal issue. You can preview the issue templates here:
